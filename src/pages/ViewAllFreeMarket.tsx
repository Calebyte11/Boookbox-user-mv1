...
const ViewAllFreeMarket = () => {
  ...
  // Fetch recommended free market when coordinates are available
  const {
  ...
  // Transform free market data to proper format for display
  // Extract unique cities for city filter
  // Transform free market data into a uniform array for UI
      ...
      <section className="p-4">
        <div className="flex items-center justify-center min-h-[50vh]">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading Free Market...</p>
          </div>
        </div>
      </section>
    );
  ...
  if (showError) {
    return (
      <section className="p-4">
        <div className="flex items-center justify-center min-h-[50vh]">
          <div className="text-center">
            <p className="text-red-600 mb-4">Failed to load free market</p>
            <Button
    ...
    <section className="p-4">
      ...
      <div className="mb-4">
        <form className="relative" onSubmit={(e) => e.preventDefault()}>
          <input
            type="text"
            placeholder="Search free market..."
            value={searchQuery}
      ...
      {filteredAndSortedItems.length > 0 ? (
        ...
        <div className="flex items-center justify-center min-h-[30vh]">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-2">No free market found</p>
            <p className="text-sm text-gray-500">
              {searchQuery
                ? "Try adjusting your search terms"
                : "No free market available at the moment"}
            </p>
          </div>
        </div>
      )}
