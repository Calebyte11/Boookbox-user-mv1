...
const ViewAllConfectionery = () => {
  ...
  // Fetch recommended confectioneries when coordinates are available
  const {
  ...
  // Transform confectionery data to proper format for display
  // Extract unique cities for city filter
  // Transform confectionery data into a uniform array for UI
  ...
  const items = useMemo(() => {
    ...
    return itemList.map((item: any) => {
      ...
      return {
        id,
        title: item.name || "Confectioneries",
  ...
  // Filter and sort confectioneries
      ...
      <section className="p-4">
        <div className="flex items-center justify-center min-h-[50vh]">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading Confectioneries...</p>
          </div>
        </div>
      </section>
    );
  ...
  if (showError) {
    return (
      <section className="p-4">
        <div className="flex items-center justify-center min-h-[50vh]">
          <div className="text-center">
            <p className="text-red-600 mb-4">Failed to load confectioneries</p>
            <Button
      ...
      {filteredAndSortedItems.length > 0 ? (
        ...
        <div className="flex items-center justify-center min-h-[30vh]">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-2">No confectioneries found</p>
            <p className="text-sm text-gray-500">
              {searchQuery
                ? "Try adjusting your search terms"
                : "No confectioneries available at the moment"}
            </p>
          </div>
        </div>
      )}
