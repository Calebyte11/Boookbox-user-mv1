...
//       email: "",
//       password: "",
//       rememberMe: false, // Simplified default
//     },
//   });
...
//     setTimeout(() => safeNavigate(target), navDelay);
//   };

//   const onSubmit = withIOSErrorHandling(async (data: SignInFormData) => {
//     if (!isInitialized) {
//       // console.warn("Form submission attempted before auth initialization");
//       return;
//     }
...
//     try {
//       // Set remember me preference safely
//       if (typeof setRememberMe === 'function') {
//         setRememberMe(data.rememberMe);
//       }

//       await signInWithEmail(data.email.toLowerCase(), data.password);
...
const SignIn: React.FC = () => {
  ...
  const onSubmit = withIOSErrorHandling(async (data: SignInFormData) => {
    ...
    try {
      ...
      // Pass rememberMe to signInWithEmail
  ...
  const handleGoogleSignIn = withIOSErrorHandling(async () => {
    ...
    try {
      ...
      // Pass rememberMeValue to signInWithGoogle
