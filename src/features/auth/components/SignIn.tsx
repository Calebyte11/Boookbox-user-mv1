...
//   // Try to get the redirect target
//   try {
//     // Check React Router state first
//     const state = location.state as { from?: string } | undefined;
...
//       console.log("✅ Using location.state.from:", target);
//     } else {
//       // Use window.location.search to get query params
...
//             console.log("✅ Decoded next:", target);
//           } catch (decodeError) {
//             console.warn("⚠️ Failed to decode, using raw:", decodeError);
//             target = next;
//           }
//         }
//       }
...
//   // Use direct navigation - avoid React Router completely
//   setTimeout(() => {
//     console.log("🚀 Navigating via window.location.href to:", target);
//     try {
