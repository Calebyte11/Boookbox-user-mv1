...
// import { Copy, X, Check, Gift } from 'lucide-react';
// import { generateShareableLink, shareToWhatsApp, shareToFacebook, shareToSMS } from '@/utils/socialShare';
...
// const RequestPackageModal: React.FC<RequestPackageModalProps> = ({ isOpen, onClose, packageData }) => {
//   const [copied, setCopied] = useState(false);

//   if (!isOpen) return null;

//   // Generate shareable link with menuId and restaurantId
//   const shareableLink = generateShareableLink(packageData.menuId, packageData.restaurantId);
...
//             Share this package with your friend and they can gift it to you!
//           </p>
//         </div>
...
//                 className="bg-linear-to-tr from-yellow-400 via-pink-500 to-purple-600 hover:opacity-90 text-white py-2.5 px-3 rounded-lg text-xs font-medium transition-opacity"
//               >
//                 Instagram
//               </button>
//               <button
