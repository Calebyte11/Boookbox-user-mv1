...
//   giftRequestData?: GiftRequestDataAuth | null; // Add gift request data prop
// }
...
//                       ? [
//                           {
//                             // ⭐ FIX: Use giftRequestData values when isGiftRequest is true
//                             // Handle organization vs individual accounts
//                             name:
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(handleBookingSubmit)}>
        ...
        {/* Auto Generate Ticket Section - Only for non-public bookings */}
        {showAutoGenerateTicket && (
          <div className="m-4">
            <div className="border-t border-gray-300 my-4" />
            <p className="text-xl font-medium mb-2">Ticket Generation</p>
            <p className="text-sm text-gray-600 mb-4">
              Choose whether to automatically generate tickets or handle
              manually
            </p>
            <Controller
              name="autoGenerateTicket"
