            ...
            <Link
              to={
                pkg.businessCategory === 'restaurant'
                  ...
                  : `${pkg.businessCategory}/${pkg.restaurantId}/meals/${pkg.menuId}`
              }
              key={pkg.id}
            ...
            >
              ...
              <div className="flex-col flex container p-2 justify-between flex-1  h-full w-40">
                ...
                <div className="flex gap-2 w-full">
                  <button 
                    type="button"
                    onClick={() => navigate(`/restaurants/${pkg.restaurantId}/meals/${pkg.menuId}`)}
                  ...
                  <button 
                    type="button"
                    className="bg-blue-500 hover:bg-blue-600 p-1.5 text-white inline-flex rounded-lg items-center justify-center gap-1 flex-1 text-xs transition-colors"
                  >
