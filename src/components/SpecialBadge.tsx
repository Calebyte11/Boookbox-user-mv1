...
interface SpecialBadgeProps {
   ...
   * @default "Special achievement badge"
   */
  ariaLabel?: string;
  /**
   * Whether the badge should be hidden from screen readers
   * @default false
   */
  ariaHidden?: boolean;
  /**
...
/**
 * SpecialBadge - A reusable award/achievement badge component
 * 
 * Displays a decorative badge with star and award styling, commonly used
 * to highlight special achievements, featured items, or premium content.
 */
export const SpecialBadge: React.FC<SpecialBadgeProps> = ({
  size = 48,
  className = '',
  color = 'currentColor',
  ariaLabel = 'Special achievement badge',
  ariaHidden = false,
  title,
}) => {
