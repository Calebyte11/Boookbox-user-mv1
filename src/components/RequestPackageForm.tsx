...
const RequestPackageForm: React.FC<RequestPackageFormProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const requestData = {
      packageId: packageData.menuId,
      businessId: packageData.restaurantId,
      quantity,
      totalPrice,
      customMessage: customMessage.trim() || "Hey, want to help get this package",
    };
          ...
          <div>
            ...
            <div className="bg-orange-50 border-2 border-orange-200 rounded-lg p-4 text-center">
              <p className="text-2xl font-bold text-orange-600">
                {formatCurrency(totalPrice, packageData.currency || "NGN")}
              </p>
